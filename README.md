...
Models can be **imported from SPICE cards** — paste a `.model` line off a datasheet and the part
is available wherever a built-in one is, kept between runs. A block can be **saved to a library**

...
The palette has a **Find a part** box (`Ctrl+F`): 184 components in 16 groups is more than anybody
...
The palette holds 184 components in 16 collapsible categories, with a **Find a part** box
(`Ctrl+F`) over them:

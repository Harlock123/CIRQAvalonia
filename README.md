...
Forty-six worked circuits ship with it, grouped and searchable in **File > Examples...** rather
than piled into a submenu — Fundamentals, Analog, Power Supplies, Switching & Motors, Digital
Logic, Timers & Oscillators, Buses & Interfaces, Sensors, Signal Integrity & RF, Displays and
Development Boards. Each one is run by the test suite and asserted against the thing it exists to show, so a
